@if(config('social.facebook') || config('social.x') || config('social.instagram'))
<div class="social-links {{ $class ?? '' }}">
    ...
    <div class="social-links-grid">
        ...
        @if($url = config('social.x'))
            <a href="{{ $url }}" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" class="social-link">
