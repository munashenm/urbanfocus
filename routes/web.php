...
Route::get('/brand/{brand:slug}', fn (Brand $brand) => redirect()->route('brands.show', $brand, 301));
Route::get('/solutions', [SeoLandingController::class, 'index'])->name('solutions.index');
Route::get('/solutions/{slug}', [SeoLandingController::class, 'show'])->name('solutions.show');

Route::prefix('knowledge-centre')->group(function () {
...
Route::redirect('/blog', '/knowledge-centre', 301);
Route::get('/blog/category/{category}', fn (string $category) => redirect()->route('blog.category', $category, 301));
Route::get('/blog/tag/{tag}', fn (string $tag) => redirect('/knowledge-centre/tag/'.$tag, 301));
Route::get('/blog/author/{author}', fn (string $author) => redirect()->route('blog.author', $author, 301));
Route::get('/blog/{article}', fn (string $article) => redirect()->route('blog.show', $article, 301));

Route::get('/case-studies', [CaseStudyController::class, 'index'])->name('case-studies.index');
Route::get('/case-studies/{slug}', [CaseStudyController::class, 'show'])->name('case-studies.show');
Route::get('/search/suggest', [SearchController::class, 'suggest'])->name('search.suggest');
Route::get('/category/{parent}/{child}', [CategoryController::class, 'showChild'])->name('categories.show.child');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('permission:products.view,products.create,products.edit,products.delete')->group(function () {
        ...
        Route::post('catalog/merge-categories', [AdminCatalogController::class, 'mergeCategories'])->middleware('permission:products.edit')->name('catalog.merge-categories');
