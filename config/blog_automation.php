...
return [
    ...
    */
    'internal_link_map' => [
        ...
        'network switch' => ['type' => 'category', 'path' => 'networking-connectivity/switches'],
        'access point' => ['type' => 'category', 'path' => 'networking-connectivity/access-points'],
        'ip camera' => ['type' => 'category', 'path' => 'security-surveillance/ip-cameras'],
        'nvr' => ['type' => 'category', 'path' => 'security-surveillance/nvr-systems'],
        'ups' => ['type' => 'category', 'path' => 'solar-power/ups-systems'],
